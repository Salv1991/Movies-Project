            ...
            <div className={filterBarStyles['upper-section']}>     
                <div className={filterBarStyles['sort-select-container']}>
                    ...
                    <div className={filterBarStyles['filter-button-container']}> 
                        <button title='ascended/descended order' className={sortByDescendedOrder? filterBarStyles['descended-button'] : filterBarStyles['ascended-button']} onClick={()=> (setSortByDescendedOrder(!sortByDescendedOrder))}>
            ...
            <div className={filterBarStyles['genre-filter-list-container']}>
                ...
                <ul>
                    {genresSelected.map((genreSelected) => (
                        <li key={genreSelected.id} onClick={()=> setGenresSelected(genresSelected.filter(genre => genre !==genreSelected))}>{genreSelected.name} <span><XMarkIcon/></span></li>
                    ))}        
                </ul>
            </div>
